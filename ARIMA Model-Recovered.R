...
cq_ts = ts(cq$Recovered, start=c(1,1), frequency=365)
gd_ts = ts(gd$Recovered, start=c(1,1), frequency=365)
hb_ts = ts(hb$Recovered, start=c(1,1), frequency=365)
sc_ts = ts(sc$Recovered, start=c(1,1), frequency=365)
ca_ts = ts(ca$Recovered, start=c(1,1), frequency=365)
mg_ts = ts(mg$Recovered, start=c(1,1), frequency=365)
nj_ts = ts(nj$Recovered, start=c(1,1), frequency=365)
ny_ts = ts(ny$Recovered, start=c(1,1), frequency=365)
ct_ts = ts(ct$Recovered, start=c(1,1), frequency=365)
fl_ts = ts(fl$Recovered, start=c(1,1), frequency=365)
la_ts = ts(la$Recovered, start=c(1,1), frequency=365)
ma_ts = ts(ma$Recovered, start=c(1,1), frequency=365)
