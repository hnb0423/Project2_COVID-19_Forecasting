...
cq_ts = ts(cq$Deaths, start=c(1,1), frequency=365)
gd_ts = ts(gd$Deaths, start=c(1,1), frequency=365)
hb_ts = ts(hb$Deaths, start=c(1,1), frequency=365)
sc_ts = ts(sc$Deaths, start=c(1,1), frequency=365)
ca_ts = ts(ca$Deaths, start=c(1,1), frequency=365)
mg_ts = ts(mg$Deaths, start=c(1,1), frequency=365)
nj_ts = ts(nj$Deaths, start=c(1,1), frequency=365)
ny_ts = ts(ny$Deaths, start=c(1,1), frequency=365)
ct_ts = ts(ct$Deaths, start=c(1,1), frequency=365)
fl_ts = ts(fl$Deaths, start=c(1,1), frequency=365)
la_ts = ts(la$Deaths, start=c(1,1), frequency=365)
ma_ts = ts(ma$Deaths, start=c(1,1), frequency=365)
...
Model = Arima(cq_ts,order=c(1,1,0)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(gd_ts,order=c(1,1,1)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(hb_ts,order=c(0,2,2)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(hb_ts,order=c(0,1,0)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(ca_ts,order=c(4,2,0)) 
...
AR#rebuild arima odel on ts object after testing
Model = Arima(nj_ts,order=c(1,2,0)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(ct_ts,order=c(1,2,2)) 
...
#rebuild arima odel on ts object after testing
Model = Arima(fl_ts,order=c(1,2,0)) 
